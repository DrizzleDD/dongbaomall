...
/**
 * @Auther: WZY
 * @Date: 2022/3/6 - 03 - 06 - 12:09
 * @Description: com.msb.msbdongbaogenerator
 * @version: 1.0
 */
public class DongBaoGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\CODE\\IDEAL_WorkSpace\\msb-dongbao-mall-parent\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("Clark");
